...
function markQuiz() {
  ...
  if (q1Response2 == "makoto yuki") {
    ...
    q1Response.style.border = "2px solid rgb(186, 255, 181)";
    q1Answer.style.color = "rgb(186, 255, 181)";
  } else {
  ...
  if (q2Response2 == "keisuke hiraga") {
    ...
    numCorrect = numCorrect + 1;
    q2Response.style.border = "2px solid rgb(186, 255, 181)";
    q2Answer.style.color = "rgb(186, 255, 181)";
  } else {
  ...
  if (q3Response2 === "gun") {
    ...
    numCorrect = numCorrect + 1;
    q3Response.style.border = "2px solid rgb(186, 255, 181)";
    q3Answer.style.color = "rgb(186, 255, 181)";
  } else {
  ...
  if (q4Response2 == "megami tensei") {
    ...
    numCorrect = numCorrect + 1;
    q4Answer.style.color = "rgb(186, 255, 181)";
    q4Response.style.border = "2px solid rgb(186, 255, 181)";
  } else {
  ...
  if (q5Response2 == "22") {
    ...
    numCorrect = numCorrect + 1;
    q5Answer.style.color = "rgb(186, 255, 181)";
    q5Response.style.border = "2px solid rgb(186, 255, 181)";
  } else {
  ...
  if (q6Response2 === "FMFL/KNK") {
    ...
    numCorrect = numCorrect + 1;
    q6Response.style.border = "2px solid rgb(186, 255, 181)";
    q6Answer.style.color = "rgb(186, 255, 181)";
  } else {
